...
require_once 'assets/php/cadastroPratica.php';
    ...
    <title>Práticas</title>
      <div id="main" class="container-fluid" >
        <div id="top" class="row" align="center">
          ...
          <!-- Pesquisa -->
          <form method="get" action="cadastrarPratica.php">
            <div class="input-group h2">
              ...
              <span class="input-group-btn">
                ...
                <button class="btn btn-primary" type="submit" id="limpar" onclick="limpa('cadastrarPratica.php');" title="Limpar pesquisa">
          ...
          <div class="modal-dialog" modal-lg role="document">
            <div class="modal-content">
              <div class="modal-header" >
                ...
                <h4 class="modal-title" id="modalLabel">Cadastro de Prática</h4>
              </div>
              <div class="modal-body">
                <form method="post" action="cadastrarPratica.php" class="celulas" id="celulas">
                  <div id="pf">
                    <div class="form-group">
                      <label class="col-md-4 control-label" for="textinput">Nome da prática</label>
                      <div class="col-md-8">
                  ...
                  <div id="pf">
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        <select id="select" name="celula_id" class="form-control" action="cadastrarPratica.php" required>
          ...
          <div class="modal-dialog" modal-lg role="document">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Editar Prática</h4>
              </div>
              <div class="modal-body">
                <form action="cadastrarPratica.php" method="post" class="celulas" id="celulas">
                  <div id="pf">
                    <div class="form-group">
        ...
        <div class="modal fade" id="delete<?php echo $queryResult[$i]->id ;?>" tabindex="-1" role="dialog" aria-labelledby="modalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Fechar"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="modalLabel">Excluir Prática</h4>
              </div>
              <form action="cadastrarPratica.php" method="post">
                <div class="modal-body">
                  Deseja realmente excluir a prática <?php echo $queryResult[$i]->nome;?>?
                </div>
